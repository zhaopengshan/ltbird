...
<script type="text/javascript">
	...
	function showSmsReply(batchId,rowId){
		var localUrl = "${ctx }/sms/smssend/jsp/readysend_replyInfo.jsp?batchId="+batchId+ "&smsReadySendId="+rowId+"&smsRe=0";
	...
	var gridPro = {
		...
		colNames:['状态','短信标题','短信内容', '短信长度','发送时间','回复','批次号'],
		colModel:[
			...
			{name:'readySendTime',width:140},		
			{name:'replyCount',width:50,align:"center",formatter:function(data){
		...
		buttons: [{
			...
			name: "collect",
			click: function(){
				var url = '${ctx}/mbnSmsReadySendAction/collectByIds.action';
