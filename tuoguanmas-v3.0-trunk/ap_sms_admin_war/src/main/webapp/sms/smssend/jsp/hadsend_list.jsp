...
<script type="text/javascript">
	...
	function showSmsReply(batchId,rowId){
		var localUrl = "${ctx }/sms/smssend/jsp/hadsend_replyInfo.jsp?batchId="+batchId+ "&smsReadySendId="+rowId+"&smsRe=0";
		$("#sms_hd_frame").load(localUrl);
	}
	var gridPro = {
		...
		colNames:['状态','短信标题','短信内容', '短信长度','发送时间','回复'],
		colModel:[
			...
			{name:'content',width:240,formatter:function(data){
			...
			{name:'completeTime',align:"center",width:130},		
			{name:'replyCount',align:"center",width:50,formatter:function(data){ 
		...
		},*/
		{
			...
			name: "collect",
			click: function(){
                var url = '${ctx}/mbnSmsHadSendAction/collectByIds.action';
