var collect_list_url = "./sms/smssend/jsp/collect_list.jsp?type=1&pageNum=1",//珍藏箱加载路径
    inbox_list_url = "./sms/smssend/jsp/inbox_list.jsp?type=2&pageNum=1",//收件箱加载路径
    readysend_list_url = "./sms/smssend/jsp/readysend_list.jsp?type=3&pageNum=1",//待发箱加载路径
    hadsend_list_url = "./sms/smssend/jsp/hadsend_list.jsp?type=4&pageNum=1",//已发箱加载路径
    draft_list_url = "./sms/smssend/jsp/draft_list.jsp?type=5&pageNum=1",//草稿箱加载路径
	current_url = collect_list_url;
	
var collect_export_url = "./mbnSmsSelectedAction/export.action?pageNum=1",//珍藏箱 导出 action
    inbox_export_url = "./mbnSmsInboxAction/export.action?pageNum=1",//收件箱 导出 action
    ...
    draft_export_url = "./mbnSmsDraftAction/export.action?pageNum=1",//草稿箱导出action
 ...
 InfoRightMenu = function(smsHdFrame,contactSearch,smsTitleSearch){
 ...
 InfoRightMenu.prototype={
 	init: function(){
 		...
 		//初始化 【珍藏记录】 选择操作
 		$("#collect_menu").unbind("click.rm").bind("click.rm",function(){
 			//控制   当前点选的  li样式 唯一
		...
		//初始化 【收件箱】 选择操作
		$("#inbox_menu").unbind("click.rm").bind("click.rm",function(){
			//控制   当前点选的  li样式 唯一
			$(this).parent().children().removeClass("zhan").end().end().addClass("zhan");
			//赋值 此 点选 的跳转页面的URL。
		...
		//初始化 【草稿箱】 选择操作
		$("#draft_menu").unbind("click.rm").bind("click.rm",function(){
			//控制   当前点选的  li样式 唯一
			$(this).parent().children().removeClass("zhan").end().end().addClass("zhan");
			//赋值 此 点选 的跳转页面的URL。
