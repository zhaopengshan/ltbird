				...
				$.ajax({
	                ...
	                success : function(data){
	                	...
	                	if(data.resultcode =="success"){
	                		href="${ctx }/sms/birthday/jsp/handsend_list.jsp";
...
<a onclick="javascript:showSendResult('${ctx }/sms/birthday/jsp/handsend_replyInfo.jsp?smsHadSendId=${mbnSmsHadSendVO.id }&batchId=${mbnSmsHadSendVO.batchId}');" href="javascript:void(0);">&nbsp;&nbsp;${mbnSmsHadSendVO.replyCount }条回复</a></td>
			</tr>
		  <tr>
