...
<script language="javascript" src="${ctx }/sms/birthday/js/info_right_menu.js" type="text/javascript" ></script>
<script type="text/javascript">
	var birthdayRightMenu;
	$(function() {
		var contactSearch = new PlaceHolder("contactSearch","输入姓名/手机"),
		    smsTitleSearch = new PlaceHolder("smsTitleSearch","输入关键字");
		birthdayRightMenu = new BirthdayRightMenu("birthday_hd_frame",contactSearch,smsTitleSearch);
		birthdayRightMenu.init();
	});
</script>
<title>短信收件箱</title>
  ...
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><DIV class=demo>
		  <div class="contents">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    <td valign="top"  id="birthday_hd_frame">
			    </td>
			    <td width="242" valign="top">
			    	<div class="right_contents">
					  ...
					  <div class="right_box">
				        <div class="list">
				          <ul>
				            <li id="hadsendbox_menu" ><a href="javascript:void(0);"><img src="${ctx }/themes/mas3/images/ico_outbox.png" style="vertical-align:middle"/>&nbsp;已发送</a></li>
				            <li id="sendbox_menu" ><a href="javascript:void(0);"><img src="${ctx }/themes/mas3/images/ico_outbox.png" style="vertical-align:middle"/>&nbsp;已提交</a></li>
				          </ul>
				        </div>
