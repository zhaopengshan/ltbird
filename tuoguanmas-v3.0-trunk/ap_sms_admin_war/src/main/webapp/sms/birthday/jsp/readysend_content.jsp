...
<div class="left_contents">
	<div class="botton_box">
	  ...
	  <!-- <div class="tubh" style="display:none;"><a href="javascript:void(0);" id="collectSmsBtn">保存珍藏</a></div> -->
	...
	<div class="table_box">
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<a onclick="javascript:showSendResult('${ctx }/sms/birthday/jsp/readysend_replyInfo.jsp?batchId=${mbnSmsReadySendVO.batchId}&smsReadySendId=${mbnSmsReadySendVO.id }');" href="javascript:void(0);"> &nbsp;&nbsp;${mbnSmsReadySendVO.replyCount } 条回复</a></td>
			</tr>
		  <tr>
			<td width="10%"   style="vertical-align: top">收件人：</td>
