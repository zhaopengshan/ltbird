...
<script type="text/javascript">
    ...
    function getCorpCountPageData(){
        $.ajax({
            url: "./corpManageAction/corpFordCountList.action",
            type:"GET",
            dataType: 'json',
    ...
    function fowardEditCorpCount(cityId){
        // 提交 编辑
        var originalUrl = "./ford/corpmanage/corplist.jsp";
        var tempUrl = "./ford/corpmanage/corplist.jsp?merchant.city="+cityId;
