...
<head>
	...
	<link href="${ctx }/themes/mas3/css/login_ford.css" rel="stylesheet" type="text/css" />
		 ...
		 <form class="login_form" id="login_form" name="login_form" action="${ctx}/masLoginLogicAction/login.action" method="post">
                ...
                <tr>
                  ...
                  <td colspan="2" valign="top" style="padding-left:60px;">
                  	<img id="login_button" src="./themes/mas3/images/login/duanxin_login1_15.gif" width="74" height="29" />
                  	<a href="${ctx }/mas3/secure/findPwd.jsp">忘记密码？</a>
                  </td>
                </tr>
              </table>
             </form>
           ...
           if(!da.existFlag){
	          ...
	          // alert(parseInt(spaceTime));
	              if(isFirstNull(da.users)){
	        	   ...
	        	   goUrl("${ctx}/mas3/secure/firstLoginPwd.jsp?account="+da.users.account+"&id="+da.users.id);
	        	   return false;
