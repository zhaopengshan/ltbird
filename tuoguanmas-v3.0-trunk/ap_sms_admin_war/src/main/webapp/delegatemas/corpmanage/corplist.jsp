...
<html>
    ...
    <body>
        <form action="./corpManageAction/removeCorpAndConfig.action" method="post" id="deletecorplist">
...
function getCorpPageData(){
    $.ajax({
        url: "./corpManageAction/pageCorp.action?page="+$("#corpcurpage").html()+"&rows="+20
            +"&merchant.name="+$("#searchCorpName").val()+"&merchant.city="+$("#merchantquery_citycondition").val(),
        type:"POST",
        dataType: 'json',
...
function fowardEditCorp(merchantPin){
    ...
    <s:if test="#session.SESSION_USER_INFO.userType==@com.leadtone.mas.admin.common.ApSmsConstants@USER_TYPE_PROVINCE_ADMIN || #session.SESSION_USER_INFO.userType==@com.leadtone.mas.admin.common.ApSmsConstants@USER_TYPE_ENTERPRISE_ADMIN">
        ...
        var taburl="./corpManageAction/showCorpAndConfig.action?merchant.merchantPin="+merchantPin;
        var tabTitle="企业信息浏览";
    ...
    <s:else>
        //var originalUrl = "./delegatemas/corpmanage/corpadd.jsp"; 
        var originalUrl = "./corpManageAction/preCorpConfigInfoNodes.action";
        var tempUrl = "./corpManageAction/showCorpAndConfig.action?merchant.merchantPin="+merchantPin;
