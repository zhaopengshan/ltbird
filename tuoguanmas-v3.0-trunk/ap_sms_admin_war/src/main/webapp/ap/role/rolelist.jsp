...
<html>
    ...
    <body>
        ...
        <ul class="rightbox">
            ...
            <li class="btn"><a href="javascript:void(0);"  id="queryRole">查 询</a></li>
        </ul>
    </body>    
</html>
<script type="text/javascript">
    ...
    function getRolePageData(){
        $.ajax({
            url: "./roleAction/query.action?page="+$("#rolecurpage").html()+"&rows="+20
    ...
    function fowardEditRole(roleId){
        // 提交 编辑
        var originalUrl = "./roleAction/forward.action?flag=addForward";
        var tempUrl = "./roleAction/forward.action?portalRole.id="+roleId+"&flag=updateForward";
    ...
    function givePower(id, name){
        ...
        var taburl="./roleAction/forward.action?flag=powerForward&portalRole.id="+id+"&portalRole.name="+name
        var tabTitle="角色赋权";
