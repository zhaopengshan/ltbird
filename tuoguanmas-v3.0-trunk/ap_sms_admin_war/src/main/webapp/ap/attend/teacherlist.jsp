        ...
        <div class="gridwrapper" style="overflow-y: auto;overflow-x: hidden;">
            <table id="contactGrid" >
                <thead>
                    ...
                    <tr style="height: 30px" class="tableopts">
                        <td colspan="6" align="left"><input type="text" style="width: 150px" value="输入教职工号查询..." id=""/>
                            <input type="text" value="输入教职工手机号码查询..." style="width: 150px" id="searchContactMobile"/> 
                            <input type="text" style="width: 150px" value="输入姓名查询..." id="searchContactName"/>
                    ...
                    <tr>
                        ...
                        <th class="tabletrhead">教职工号</th>
                        <th class="tabletrhead">教职工手机号</th>
                        <th class="tabletrhead">姓名</th>
                        <th class="tabletrhead">性别</th>
                        <th class="tabletrhead">分组</th>
                        <th class="tabletrhead">日期</th>
                        <th class="tabletrhead">刷卡时间1</th>
                        <th class="tabletrhead">刷卡时间2</th>
                    </tr>
                                      
                </thead>
                <tbody id="attend_list">
					<tr>
                        <td><input type="checkbox" name="contactsselect"  /></td>
                        <td>0001</td>
                        <td>13676767676</td>
                        <td>张三</td>
                        <td>男</td>
					...
					<tr>
                        ...
                        <td>教师</td>
                        <td>2013-08-20 周二</td>
                        <td><span class="red">9：30</span></td>
                        <td><span class="red">16:00</span></td>
                    </tr>  
					<tr>
                        <td><input type="checkbox" name="contactsselect"  /></td>
                        <td>0004</td>
                ...
                <tfoot>
                    <tr class="tableopts">
                        <td colspan="9" id="footcontactpaginate" style="text-align: right">
        ...
        <script type="text/javascript">	
            ...
            $(function() {
                ...
                $("#forwardnewcontact").unbind("click").click(function(){
                    $("#addressDialogLoad").load("./ap/teacher/addressDialog.jsp",function(){
            ...
            function addAddressRow(data){
                ...
                $("#contactdatalist tr:last td").eq(6).html(data.lastModifyTime);
            }
