            ...
            <table id="contactGrid" >
                <thead>
                    ...
                    <tr style="height: 30px" class="tableopts">
                        <td colspan="6" align="left"><input type="text" style="width: 150px" value="输入学号查询..." id=""/>
                            <input type="text" value="输入亲情号1查询..." style="width: 150px" id="searchContactMobile"/> 
                    ...
                    <tr>
                        ...
                        <th class="tabletrhead">学号</th>
                        <th class="tabletrhead">亲情号1</th>
