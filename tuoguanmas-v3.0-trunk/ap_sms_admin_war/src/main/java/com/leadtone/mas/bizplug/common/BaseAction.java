...
public class BaseAction extends ActionSupport {
	 ...
	 * 根据手机号查询
	 */
	protected String searchByMobile;
	/**
	 * 根据失败原历查询
	 */
	protected String searchByFailReason;
	
	public String getSearchByFailReason() {
		return searchByFailReason;
	}



	public void setSearchByFailReason(String searchByFailReason) {
		this.searchByFailReason = searchByFailReason;
	}



	public String getSearchByMobile() {
		return searchByMobile;
	}



	public void setSearchByMobile(String searchByMobile) {
		this.searchByMobile = searchByMobile;
	}
	 ...
	 * 业务类型
	 */
	protected String operationId = "hd";
	 ...
	 * @return
	 */
	protected Users getSessionUsers(){
		return (Users)getSession().getAttribute(ApSmsConstants.SESSION_USER_INFO);
	}
