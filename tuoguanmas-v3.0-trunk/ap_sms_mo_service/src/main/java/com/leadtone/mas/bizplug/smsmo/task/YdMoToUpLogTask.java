...
public class YdMoToUpLogTask implements Callable<Integer> {
	
	private Logger logger = Logger.getLogger(YdMoToUpLogTask.class);
	
	private GwSmsMoLogDao gwSmsMoLogDao;
	private SmsMoLogDao smsMoLogDao;
	
	public YdMoToUpLogTask(GwSmsMoLogDao gwSmsMoLogDaoTemp, SmsMoLogDao smsMoLogDaoTemp){
...
//			}
			for (Iterator<SmsMoLogBean> it = listSmsMoLogBean.iterator(); it.hasNext();) {
				...
				smsMoLogBean.setType("CMCC");
				smsMoLogBean.setClassify(1);
