...
public class NOKIACMPPGateway extends NOKIAGatewayEngine
{
    static final int NOKIA_TRANSCEIVER_PORT = 7890;
    public SessionConfig m_scTransceiver;
    

    public NOKIACMPPGateway(String strName, ServiceProvider sp)
    {
        super(strName, 0x20602, sp);
