...
public class SITECHGateway extends CMPPGatewayEngine
{
    static final int SITECH_TRANSCEIVER_PORT = 7890;
    public SessionConfig m_scTransceiver;

    public SITECHGateway(String strName, ServiceProvider sp)
    {
        super(strName, 0x20500, sp);
    ...
    public boolean loadAllSessions(String strHostAddress)
    {
        ...
        Log.log("SITECHGateway(" + m_strName + ").loadAllSessions : unexpected exit !", 0x2000080000000000L);
        return false;
    }
    ...
    public CMPPQueryResponse getConfig()
    {
        ...
        Log.log("SITECHGateway.getConfig : unexpected exit !", 0x2000080000000000L);
        return null;
    }
