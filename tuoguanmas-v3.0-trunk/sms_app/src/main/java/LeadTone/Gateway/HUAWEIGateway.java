...
public class HUAWEIGateway extends CMPPGatewayEngine
{
    static final int HUAWEI_TRANSCEIVER_PORT = 7890;
    public SessionConfig m_scTransceiver;
    

    public HUAWEIGateway(String strName, ServiceProvider sp)
    {
        super(strName, 0x20900, sp);
    ...
    public boolean loadAllSessions(String strHostAddress)
    {
        ...
        Log.log("HUAWEIGateway(" + m_strName + ").loadAllSessions : unexpected exit !", 0x2000080000000000L);
        return false;
    }
    ...
    public CMPPQueryResponse getConfig()
    {
        ...
        Log.log("HUAWEIGateway.getConfig : unexpected exit !", 0x2000080000000000L);
        return null;
    }
