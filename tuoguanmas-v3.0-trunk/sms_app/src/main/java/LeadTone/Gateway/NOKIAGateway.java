...
public class NOKIAGateway extends NOKIAGatewayEngine
{
    static final int NOKIA_TRANSMITTER_PORT = 7890;
    static final int NOKIA_RECEIVER_PORT = 7890;
    public SessionConfig m_scTransmitter;
    public SessionConfig m_scReceiver;

    public NOKIAGateway(String strName, ServiceProvider sp)
    {
        super(strName, 0x20601, sp);
    ...
    public boolean loadTransmitterSession(String strHostAddress)
    {
        ...
        Log.log("NOKIAGateway(" + m_strName + ").loadTransmitterSessions : unexpected exit !", 0x2000080000000000L);
        return false;
    }
    ...
    public boolean loadReceiverSession(String strHostAddress)
    {
        ...
        Log.log("NOKIAGateway(" + m_strName + ").loadReceiverSessions : unexpected exit !", 0x2000080000000000L);
        return false;
    }
    ...
    public CMPPQueryResponse getConfig()
    {
        ...
        Log.log("NOKIAGateway.getConfig : unexpected exit !", 0x2000080000000000L);
        return null;
    }
