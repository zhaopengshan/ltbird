package com.leadtone.mas.bizplug.tunnelmanage.action;
...
@Component("com.leadtone.mas.bizplug.smssend.action.SmsTunnelAction")
@Scope("prototype")
...
public class SmsTunnelAction extends BaseAction {
	...
	results = { @Result(name = SUCCESS, location = "/tunnelManage/jsp/smstunnel_info.jsp"),
	...
	results = { @Result(name = SUCCESS, location = "/tunnelManage/jsp/smstunnel_flow.jsp"),
				@Result(name = ERROR, location = "/error.jsp"),
