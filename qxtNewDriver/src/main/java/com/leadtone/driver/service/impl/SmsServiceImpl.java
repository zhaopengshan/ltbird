...
public class SmsServiceImpl implements ISmsService {
	...
	public List<SmsBean> getReadySendSms(Long merchantPin, int tunnelType, int sendResult, String readSendTime, int limit, String orderFlag, String createBy,boolean perAccount) {
		return smsDao.getReadySendSms(merchantPin, tunnelType, sendResult,readSendTime,limit,orderFlag, createBy, perAccount);
	}
	...
	@Override
	public List<SmsBean> getReportSms(Long merchantPin, List<ReportResult> resultMap, String uid, boolean perAccount) {
		return smsDao.getReportSms(merchantPin, resultMap, uid, perAccount);
	}
